...
/**Jest to program demonstrujacy uzycie metody equals
 * 
 * @author epiotno
 *
 */
public class EqualsTest {
	public static void main(String[] args)
	{
		...
		System.out.println("carl.equls(boss): " + carl.equals(boss));
		System.out.println("alice.hashCode(): " + alice1.hashCode());
